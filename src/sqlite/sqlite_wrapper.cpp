...
int simpleQueryPinyinCallback(void* data, int argc, char** argv,
                              char** azColName) {
    UserData* userData = static_cast<UserData*>(data);
    // std::vector<std::pair<std::string, long>>& myVec = userData->result;
...
*/
std::vector<std::pair<std::string, long>> queryPinyin(sqlite3* db,
                                                      std::string pinyin) {
    ...
    // 查询
    result = sqlite3_exec(db, querySQL.c_str(), queryPinyinCallback, &userData,
                          &errMsg);
...
std::vector<std::pair<std::string, long>> queryPinyinWithHelperCode(
    sqlite3* db, std::string pinyin) {
    std::vector<std::pair<std::string, long>> resVec;
    std::string tblName = "fullpinyinsimple";
...
/*
    查询两个字的条目
*/
std::vector<std::pair<std::string, long>> queryTwoPinyin(sqlite3* db,
                                                         std::string pinyin) {
    std::vector<std::pair<std::string, long>> resVec;
    std::string tblName = "fullpinyinsimple";
    // std::string querySQL = "select * from " + tblName + " where key like " +
...
/*
    查询三个字的条目
*/
std::vector<std::pair<std::string, long>> queryThreePinyin(sqlite3* db,
                                                           std::string pinyin) {
    std::vector<std::pair<std::string, long>> resVec;
    std::string tblName = "fullpinyinsimple";
    // 双拼码是六个字符
...
/*
    查询四个字的条目
*/
std::vector<std::pair<std::string, long>> queryFourPinyin(sqlite3* db,
                                                          std::string pinyin) {
    std::vector<std::pair<std::string, long>> resVec;
    std::string tblName = "fullpinyinsimple";
    // 双拼码是八个字符
...
/*
    查询五个字的条目
*/
std::vector<std::pair<std::string, long>> queryFivePinyin(sqlite3* db,
                                                          std::string pinyin) {
    std::vector<std::pair<std::string, long>> resVec;
    std::string tblName = "fullpinyinsimple";
    // 双拼码是10个字符
...
/*
    查询超过五个字的条目
*/
std::vector<std::pair<std::string, long>> queryManyPinyin(sqlite3* db,
                                                          std::string pinyin) {
    std::vector<std::pair<std::string, long>> resVec;
    std::string tblName = "fullpinyinsimple";
    // 双拼码是10个字符
...
/*
    超过两个字的处理逻辑：
        ...
        还可以再优化
*/
std::vector<std::pair<std::string, long>> queryMultiPinyin(sqlite3* db,
                                                           std::string pinyin) {
    std::vector<std::pair<std::string, long>> resVec;
    if (pinyin.size() <= 6) {
...
/*
    单字查询的分页
*/
std::vector<std::vector<std::pair<std::string, long>>> queryPinyinInPage(
    sqlite3* db, std::string pinyin) {
    std::vector<std::vector<std::pair<std::string, long>>> pagedVec;
    std::vector<std::pair<std::string, long>> noPagedVec =
        queryPinyin(db, pinyin);
...
queryPinyinWithHelperCodeInPage(sqlite3* db, std::string pinyin) {
    std::vector<std::vector<std::pair<std::string, long>>> pagedVec;
    std::vector<std::pair<std::string, long>> noPagedVec =
        queryPinyinWithHelperCode(db, pinyin);
...
/*
    两个字的条目的分页
*/
std::vector<std::vector<std::pair<std::string, long>>> queryTwoPinyinInPage(
    sqlite3* db, std::string pinyin) {
    std::vector<std::vector<std::pair<std::string, long>>> pagedVec;
    std::vector<std::pair<std::string, long>> noPagedVec =
        queryTwoPinyin(db, pinyin);
...
std::vector<std::vector<std::pair<std::string, long>>> queryMultiPinyinInPage(
    sqlite3* db, std::string pinyin) {
    std::vector<std::vector<std::pair<std::string, long>>> pagedVec;
    std::vector<std::pair<std::string, long>> noPagedVec =
        queryMultiPinyin(db, pinyin);
...
/*
   ...
   ?"
    ...
    return:
            ...
            1 -> 更新成功
*/
int updateItemWeightInDb(sqlite3* db, std::string pinyin, std::string hans,
                         long weight) {
    std::string tblName = "fullpinyinsimple";
    ...
    std::string updateSQL = "update " + tblName +
                            " set weight = " + curWeightStr + " where key = '" +
                            pinyin + "' and value = '" + hans + "'";
    // std::cout << updateSQL << '\n';
...
bool comparePairs(const std::pair<std::string, long>& pair1,
                  const std::pair<std::string, long>& pair2) {
...
/*
   ...
   的速度会拖慢这个进程的。
*/
std::vector<std::pair<std::string, long>> queryOneChar(sqlite3* db,
                                                       std::string pinyin) {
    std::vector<std::pair<std::string, long>> resVec;
    std::string tblName = "fullpinyinsimple";
    ...
    */
    /*
        ...
        LIMIT 80;
    */
    std::string querySQL = "select * from " + tblName + " where key >= '" +
                           pinyin + "a' and key <= '" + pinyin +
...
/*
    ...
    返回值：vector<vector<pair<string, long>>>
*/
std::vector<std::pair<std::string, long>> queryTwoChars(sqlite3* db,
                                                        std::string pinyin) {
    std::vector<std::pair<std::string, long>> resVec;
    std::string tblName = "fullpinyinsimple";
    ...
    std::string querySQL = "select * from " + tblName + " where key  = '" +
                           pinyin + "' order by weight desc limit 80";
    // std::cout << querySQL << '\n';
    int result;
    char* errMsg = nullptr;
    int itemCount = 0;
...
/*
    ...
    返回值：vector<vector<pair<string, long>>>
*/
std::vector<std::pair<std::string, long>> queryThreeChars(sqlite3* db,
                                                          std::string pinyin) {
    ...
    std::string tblName = "fullpinyinsimple";
    std::string querySQL =
        "select * from " + tblName + " where key like '" + pinyin02 + "[" +
        pinyin01 + "%' and key >= '" + pinyin02 + "[" + pinyin01 +
        "a' and key <= '" + pinyin + "[" + pinyin01 +
        "z' and length(key) == 5 order by weight desc limit 80";
    std::string querySQL02 =
        "select * from " + tblName + " where key like '" + pinyin +
        "%' and key >= '" + pinyin + "a' and key <= '" + pinyin +
        "z' and length(key) == 4 order by weight desc limit 80";
    std::string querySQL03 = "select * from " + tblName + " where key ='" +
                             pinyin02 + "' order by weight desc limit 80";
    // std::cout << querySQL << '\n';
    int result;
    char* errMsg = nullptr;
    int itemCount = 0;
    ...
    // 第二次查询
    result = sqlite3_exec(db, querySQL02.c_str(), queryPinyinCallback,
                          &userData, &errMsg);
    // std::cout << "itemCnt = " << itemCount << '\n';
    if (result) {
        // Todo: 日志
    ...
    // 第三次查询
    result = sqlite3_exec(db, querySQL03.c_str(), queryPinyinCallback,
                          &userData, &errMsg);
    // std::cout << "itemCnt = " << itemCount << '\n';
    if (result) {
        // Todo: 日志
...
/*
    ...
    返回值：vector<vector<pair<string, long>>>
*/
std::vector<std::pair<std::string, long>> queryFourChars(sqlite3* db,
                                                         std::string pinyin) {
    ...
    std::string tblName = "fullpinyinsimple";
    std::string querySQL = "select * from " + tblName + " where key = '" +
                           pinyin + "' order by weight desc limit 400";
    std::string querySQL02 = "select * from " + tblName + " where key ='" +
                             pinyin02 + "' order by weight desc limit 400";
    // std::cout << querySQL << '\n';
    int result;
    char* errMsg = nullptr;
    int itemCount = 0;
...
/*
    ...
    返回值：vector<vector<pair<string, long>>>
*/
std::vector<std::pair<std::string, long>> queryFourCharsWithHelper(
    sqlite3* db, std::string pinyin) {
    std::vector<std::pair<std::string, long>> resVec;
    std::string tblName = "fullpinyinsimple";
    std::string querySQL =
...
*/
std::vector<std::pair<std::string, long>> queryFiveChars(sqlite3* db,
                                                         std::string pinyin) {
    // std::string pinyin02 = pinyin.substr(0, 1);  // 切第一个字符
    ...
    std::string querySQL =
        "select * from " + tblName + " where key like '" + pinyin +
        "%' and key >= '" + pinyin + "a' and key <= '" + pinyin +
        "z' and length(key) == 6 order by weight desc limit 80";
    /*
        百步穿杨：bdbuiryh
    ...
    */
    std::string querySQL02 =
        "select * from " + tblName + " where key like '" + pinyin +
        "%' and key >= '" + pinyin + "a' and key <= '" + pinyin +
        "zzz' and length(key) == 8 order by weight desc limit 80";
    std::string querySQL03 = "select * from " + tblName + " where key = '" +
                             pinyin02 + "' order by weight desc limit 80";
    std::string querySQL04 = "select * from " + tblName + " where key  = '" +
                             pinyin03 + "' order by weight desc limit 80";
    // std::cout << querySQL << '\n';
    int result;
    char* errMsg = nullptr;
    int itemCount = 0;
    ...
    // 第四次查询
    result = sqlite3_exec(db, querySQL04.c_str(), queryPinyinCallback,
                          &userData, &errMsg);
    // std::cout << "itemCnt = " << itemCount << '\n';
    if (result) {
        // Todo: 日志
...
/*
    ...
    返回值：vector<vector<pair<string, long>>>
*/
std::vector<std::pair<std::string, long>> queryFiveCharsWithHelper(
    sqlite3* db, std::string pinyin) {
    // std::string pinyin02 = pinyin.substr(0, 1);  // 切第一个字符
    std::string pinyin02 = pinyin.substr(0, 2);  // 切前两个字符
    std::vector<std::pair<std::string, long>> resVec;
...
/*
    ...
    说明：这里也要把四字的成语给查询出来
*/
std::vector<std::pair<std::string, long>> querySixChars(sqlite3* db,
                                                        std::string pinyin) {
    // std::string pinyin02 = pinyin.substr(0, 1);  // 切第一个字符
    ...
    */
    std::string querySQL02 =
        "select * from " + tblName + " where key like '" + pinyin +
        "%' and key >= '" + pinyin + "a' and key <= '" + pinyin +
        "zz' and length(key) == 8 order by weight desc limit 80";
    std::string querySQL03 = "select * from " + tblName + " where key = '" +
                             pinyin02 + "' order by weight desc limit 80";
    std::string querySQL04 = "select * from " + tblName + " where key ='" +
                             pinyin03 + "' order by weight desc limit 80";
...
/*
    ...
    返回值：vector<vector<pair<string, long>>>
*/
std::vector<std::pair<std::string, long>> querySevenChars(sqlite3* db,
                                                          std::string pinyin) {
    // std::string pinyin02 = pinyin.substr(0, 1);  // 切第一个字符
    ...
    std::string querySQL =
        "select * from " + tblName + " where key like '" + pinyin +
        "%' and key >= '" + pinyin + "a' and key <= '" + pinyin +
        "z' and length(key) == 8 order by weight desc limit 80";
    std::string querySQL02 = "select * from " + tblName + " where key = '" +
                             pinyin02 + "' order by weight desc limit 80";
    std::string querySQL03 = "select * from " + tblName + " where key = '" +
                             pinyin03 + "' order by weight desc limit 80";
    std::string querySQL04 = "select * from " + tblName + " where key = '" +
                             pinyin04 + "' order by weight desc limit 80";
    // std::cout << querySQL << '\n';
    int result;
    char* errMsg = nullptr;
    int itemCount = 0;
...
/*
    ...
    返回值：vector<vector<pair<string, long>>>
*/
std::vector<std::pair<std::string, long>> queryEightChars(sqlite3* db,
                                                          std::string pinyin) {
    // std::string pinyin02 = pinyin.substr(0, 1);  // 切第一个字符
    std::string pinyin02 = pinyin.substr(0, 6);  // 切前六个字符
    std::string pinyin03 = pinyin.substr(0, 4);  // 切前四个字符
...
/*
    ...
    返回值：vector<vector<pair<string, long>>>
*/
std::vector<std::pair<std::string, long>> queryNineChars(sqlite3* db,
                                                         std::string pinyin) {
    ...
    std::string querySQL =
        "select * from " + tblName + " where key like '" + pinyin +
        "%' and key >= '" + pinyin + "a' and key <= '" + pinyin +
        "z' and length(key) == 10 order by weight desc limit 80";
    std::string querySQL02 = "select * from " + tblName + " where key = '" +
                             pinyin02_8 + "' order by weight desc limit 80";
    std::string querySQL03 = "select * from " + tblName + " where key = '" +
                             pinyin03_6 + "' order by weight desc limit 80";
    std::string querySQL04 = "select * from " + tblName + " where key = '" +
                             pinyin04_4 + "' order by weight desc limit 80";
    std::string querySQL05 = "select * from " + tblName + " where key = '" +
                             pinyin05_2 + "' order by weight desc limit 80";
    int result;
    char* errMsg = nullptr;
    int itemCount = 0;
    UserData userData{itemCount, resVec};
    ...
    // 第 5 次查询
    result = sqlite3_exec(db, querySQL05.c_str(), queryPinyinCallback,
                          &userData, &errMsg);
    // std::cout << "itemCnt = " << itemCount << '\n';
    if (result) {
        // Todo: 日志
...
/*
    ...
    返回值：vector<vector<pair<string, long>>>
*/
std::vector<std::pair<std::string, long>> queryTenChars(sqlite3* db,
                                                        std::string pinyin) {
    std::string pinyin02_8 = pinyin.substr(0, 8);  // 切前 8 个字符
    std::string pinyin03_6 = pinyin.substr(0, 6);  // 切前 6 个字符
    std::string pinyin04_4 = pinyin.substr(0, 4);  // 切前 4 个字符
...
/*
    ...
    返回值：vector<vector<pair<string, long>>>
*/
std::vector<std::pair<std::string, long>> queryElevenChars(sqlite3* db,
                                                           std::string pinyin) {
    ...
    std::string querySQL =
        ...
        "z' and length(key) == 10 order by weight desc limit 80";
    std::string querySQL02 = "select * from " + tblName + " where key = '" +
                             pinyin02_10 + "' order by weight desc limit 80";
    std::string querySQL03 = "select * from " + tblName + " where key = '" +
                             pinyin03_8 + "' order by weight desc limit 80";
    std::string querySQL04 = "select * from " + tblName + " where key = '" +
                             pinyin04_6 + "' order by weight desc limit 80";
    std::string querySQL05 = "select * from " + tblName + " where key = '" +
                             pinyin05_4 + "' order by weight desc limit 80";
    std::string querySQL06 = "select * from " + tblName + " where key = '" +
                             pinyin06_2 + "' order by weight desc limit 80";
    int result;
    char* errMsg = nullptr;
    int itemCount = 0;
    UserData userData{itemCount, resVec};
    ...
    // 第 6 次查询
    result = sqlite3_exec(db, querySQL06.c_str(), queryPinyinCallback,
                          &userData, &errMsg);
    // std::cout << "itemCnt = " << itemCount << '\n';
    if (result) {
        // Todo: 日志
...
/*
    ...
    返回值：vector<vector<pair<string, long>>>
*/
std::vector<std::pair<std::string, long>> queryTwelveChars(sqlite3* db,
                                                           std::string pinyin) {
    std::string pinyin02_10 = pinyin.substr(0, 10);  // 切前 10 个字符
    std::string pinyin03_8 = pinyin.substr(0, 8);    // 切前 8 个字符
    std::string pinyin04_6 = pinyin.substr(0, 6);    // 切前 6 个字符
...
/*
    ...
    返回值：vector<vector<pair<string, long>>>
*/
std::vector<std::pair<std::string, long>> queryThirteenChars(
    sqlite3* db, std::string pinyin) {
    ...
    std::string querySQL =
        ...
        "z' and length(key) == 10 order by weight desc limit 80";
    std::string querySQL02 = "select * from " + tblName + " where key = '" +
                             pinyin02_12 + "' order by weight desc limit 80";
    std::string querySQL03 = "select * from " + tblName + " where key = '" +
                             pinyin03_10 + "' order by weight desc limit 80";
    std::string querySQL04 = "select * from " + tblName + " where key = '" +
                             pinyin04_8 + "' order by weight desc limit 80";
    std::string querySQL05 = "select * from " + tblName + " where key = '" +
                             pinyin05_6 + "' order by weight desc limit 80";
    std::string querySQL06 = "select * from " + tblName + " where key = '" +
                             pinyin06_4 + "' order by weight desc limit 80";
    std::string querySQL07 = "select * from " + tblName + " where key = '" +
                             pinyin07_2 + "' order by weight desc limit 80";
    int result;
    char* errMsg = nullptr;
    int itemCount = 0;
    UserData userData{itemCount, resVec};
    ...
    // 第 7 次查询
    result = sqlite3_exec(db, querySQL07.c_str(), queryPinyinCallback,
                          &userData, &errMsg);
    // std::cout << "itemCnt = " << itemCount << '\n';
    if (result) {
        // Todo: 日志
...
/*
    ...
    返回值：vector<vector<pair<string, long>>>
*/
std::vector<std::pair<std::string, long>> queryFourteenChars(
    sqlite3* db, std::string pinyin) {
...
/*
    ...
    返回值：vector<vector<pair<string, long>>>
*/
std::vector<std::pair<std::string, long>> queryFifteenChars(
    sqlite3* db, std::string pinyin) {
    ...
    std::string querySQL =
        ...
        "z' and length(key) == 10 order by weight desc limit 80";
    std::string querySQL02 = "select * from " + tblName + " where key = '" +
                             pinyin02_14 + "' order by weight desc limit 80";
    std::string querySQL03 = "select * from " + tblName + " where key = '" +
                             pinyin03_12 + "' order by weight desc limit 80";
    std::string querySQL04 = "select * from " + tblName + " where key = '" +
                             pinyin04_10 + "' order by weight desc limit 80";
    std::string querySQL05 = "select * from " + tblName + " where key = '" +
                             pinyin05_8 + "' order by weight desc limit 80";
    std::string querySQL06 = "select * from " + tblName + " where key = '" +
                             pinyin06_6 + "' order by weight desc limit 80";
    std::string querySQL07 = "select * from " + tblName + " where key = '" +
                             pinyin07_4 + "' order by weight desc limit 80";
    std::string querySQL08 = "select * from " + tblName + " where key = '" +
                             pinyin08_2 + "' order by weight desc limit 80";
    int result;
    char* errMsg = nullptr;
    int itemCount = 0;
    UserData userData{itemCount, resVec};
    ...
    // 第 8 次查询
    result = sqlite3_exec(db, querySQL08.c_str(), queryPinyinCallback,
                          &userData, &errMsg);
    // std::cout << "itemCnt = " << itemCount << '\n';
    if (result) {
        // Todo: 日志
...
/*
    ...
    返回值：vector<vector<pair<string, long>>>
*/
std::vector<std::pair<std::string, long>> querySixteenChars(
    sqlite3* db, std::string pinyin) {
    std::string pinyin02_14 = pinyin.substr(0, 14);  // 切前 14 个字符
    std::string pinyin03_12 = pinyin.substr(0, 12);  // 切前 12 个字符
    std::string pinyin04_10 = pinyin.substr(0, 10);  // 切前 10 个字符
...
/*
    所有查询的分页
*/
std::vector<std::vector<std::pair<std::string, long>>> queryCharsInPage(
    sqlite3* db, std::string hankey) {
...
int insertItem(sqlite3* db, std::string pinyin, std::string hanValue) {
    std::vector<std::pair<std::string, long>> resVec;
    std::string tblName = "fullpinyinsimple";
    std::string querySQL = "select count(*) from " + tblName +
                           " where key = '" + pinyin + "' and value = '" +
                           hanValue + "'";
    std::string insertSQL = "insert into " + tblName +
                            " (key, value, weight) values ('" + pinyin +
                            "', '" + hanValue + "', 0)";
    ...
    UserData userData{itemCount, resVec};
    // 查询
    result = sqlite3_exec(db, querySQL.c_str(), simpleQueryPinyinCallback,
                          &userData, &errMsg);
    if (result != SQLITE_OK) {
        std::cout << "query error!" << '\n';
    }
